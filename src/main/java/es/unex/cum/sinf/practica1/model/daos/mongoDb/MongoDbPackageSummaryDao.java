...
public class MongoDbPackageSummaryDao implements PackageSummaryDao {
    ...
    public void insert(PackageReservationSummary packageReservationSummary) {
        /*Document document = new Document("_id", packageReservationSummary.getPackageId().toString())
                .append("total_reservations", packageReservationSummary.getTotalReservations());
